            ...
            if (Physics.Raycast(ray, out RaycastHit hit)) {
                ...
                if (obj.name.Equals("学生电源")) {
                    camera.transform.position = new Vector3(
                        ...
                        obj.transform.position.y + 0.40807f,
                        obj.transform.position.z - 0.4822f
                    );
                }
                if (obj.name.Equals("开关")) {
                    camera.transform.position = new Vector3(
                        obj.transform.position.x + 0.022f,
                        obj.transform.position.y + 0.148f,
                        obj.transform.position.z - 0.1256f
                    );
                }
